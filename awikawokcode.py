...
class PaymentWindow(ctk.CTkToplevel):
    ...
    def refresh_display(self):
        ...
        # PERBAIKAN VITAL: Selalu ambil total terbaru dari aplikasi utama
    ...
    def create_cart_detail_section(self, parent_frame):
        ...
        for name, data in self.cart_items.items():
            ...
            # Subtotal (Menggunakan data yang sudah diperbarui)
        ...
        # Menggunakan self.master_app.cart_total yang sudah diperbarui
