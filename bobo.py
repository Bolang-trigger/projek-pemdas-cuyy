...
# KELAS PAYMENT WINDOW (PENGGANTI CHECKOUTWINDOW LAMA)
...
class WeaponShowcaseApp(ctk.CTk):
    def __init__(self):
        ...
        # DATA PRODUK SENJATA
        self.weapons = [
            {"name": "Pistol Taktis X-15", "price": "Rp 5.500.000", "desc": "Pistol modular dengan akurasi dan kontrol recoil tinggi.", "image": "pistol_x15.png"},
            {"name": "Senapan Serbu AR-2030", "price": "Rp 18.000.000", "desc": "Senapan serbu ringan, ideal untuk pertempuran jarak menengah.", "image": "ar_2030.png"},
            {"name": "Shotgun Defender S12", "price": "Rp 7.800.000", "desc": "Shotgun pump-action, daya henti kuat untuk jarak dekat.", "image": "shotgun_s12.png"},
            {"name": "Senapan Sniper Alpha", "price": "Rp 25.000.000", "desc": "Senapan sniper presisi ekstrem, kaliber berat.", "image": "sniper_alpha.png"},
            {"name": "Pistol Defender P900", "price": "Rp 4.200.000", "desc": "Pistol kompak untuk pertahanan diri.", "image": "pistol_p900.png"},
            {"name": "pistol taurus judge defender", "price": "Rp 6.500.000", "desc": "Revolver magnum dengan daya tembak luar biasa.", "image": "taurus_judge.png"},
            {"name": "Pisau Karambit Shadow", "price": "Rp 1.200.000", "desc": "Pisau taktis dengan desain melengkung untuk pertarungan jarak dekat.", "image": "karambit.png"},
            {"name": "Golok Prajurit", "price": "Rp 900.000", "desc": "Golok serbaguna untuk keperluan outdoor dan pertahanan diri.", "image": "golok.png"},
            {"name": "Granat Asap M18", "price": "Rp 750.000", "desc": "Granat asap untuk penandaan posisi atau pengalihan perhatian.", "image": "granade_asap.png"},
        ]
    ...
    def buy_weapon(self, weapon_data):
        ...
        parsed_price = self._parse_price(weapon_data['price'])
    ...
    # LOGIKA ETALASE (Tidak ada perubahan)
    ...
    def filter_weapons(self, event=None):
        ...
        filtered = [
            ...
            if search_query in weapon["name"].lower()
        ]
    ...
    def create_weapon_item(self, parent_frame, weapon_data, row, col):
        ...
        image_path = os.path.join(os.getcwd(), weapon_data["image"])
        image_size = (250, 150) 
        ...
        try:
            ...
            no_image_label = ctk.CTkLabel(item_frame, 
                                          text=f"File gambar: '{weapon_data['image']}'\nTIDAK DITEMUKAN!",
                                          text_color="red",
